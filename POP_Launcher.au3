...
#AutoIt3Wrapper_Outfile=POP_Launcher.exe
#AutoIt3Wrapper_Compression=4
#AutoIt3Wrapper_UseUpx=n
#AutoIt3Wrapper_UPX_Parameters=-9 --strip-relocs=0 --compress-exports=0 --compress-icons=0
#AutoIt3Wrapper_Res_Description=Prince of Persia TSoT Launcher
...
#pragma compile(FileDescription, 'Prince of Persia TSoT Launcher')
#pragma compile(FileVersion, 1.0.0.47)
#pragma compile(InternalName, 'Prince of Persia TSoT Launcher')
#pragma compile(LegalCopyright, '2014, SalFisher47')
#pragma compile(OriginalFilename, POP_Launcher.exe)
#pragma compile(ProductName, 'Prince of Persia TSoT Launcher')
#pragma compile(ProductVersion, 1.0.0.47)
#EndRegion ;**** Pragma Compile ****
; === UniCrack Installer.au3 =======================================================================================================
; Title .........: Prince of Persia TSoT Launcher
; Version .......: 1.0.0.47
; AutoIt Version : 3.3.14.5
; Language ......: English
; Description ...: Prince of Persia TSoT Widescreen Launcher
;				   - based on UniWS
...
$widescreen_fix_ini = @ScriptDir & "\POP_Launcher.ini"
FileInstall("POP_Launcher.ini", $widescreen_fix_ini, 0)
...
FileInstall("POP_ProgramData.ini", @AppDataCommonDir & "\SalFisher47\WidescreenLauncher\POP1.ini", 0)
$patched_ProgramData = IniRead(@AppDataCommonDir & "\SalFisher47\WidescreenLauncher\POP1.ini", "EXE", "patched", 0)
If Not FileExists($exe32bit) Then
	MsgBox(16, "Prince of Persia TSoT Launcher", "Executable not found:" & @CRLF & "..\POP.exe")
	Exit
EndIf
Local $POP_4_by_3_array[1], $POP_4_by_3_txt = @ScriptDir & "\WidescreenLauncher\POP_1.33 (4 by 3 aspect ratio).txt", $POP_4_by_3_7z = StringTrimRight($POP_4_by_3_txt, 4) & ".7z"
Local $POP_5_by_4_array[1], $POP_5_by_4_txt = @ScriptDir & "\WidescreenLauncher\POP_1.25 (5 by 4 aspect ratio).txt", $POP_5_by_4_7z = StringTrimRight($POP_5_by_4_txt, 4) & ".7z"
Local $POP_16_by_9_array[1], $POP_16_by_9_txt = @ScriptDir & "\WidescreenLauncher\POP_1.77 (16 by 9 aspect ratio).txt", $POP_16_by_9_7z = StringTrimRight($POP_16_by_9_txt, 4) & ".7z"
Local $POP_16_by_10_array[1], $POP_16_by_10_txt = @ScriptDir & "\WidescreenLauncher\POP_1.60 (16 by 10 aspect ratio).txt", $POP_16_by_10_7z = StringTrimRight($POP_16_by_10_txt, 4) & ".7z"
Local $POP_Backup = @ScriptDir & "\WidescreenLauncher\POP_Backup.7z"
;Local $POP_Blank = @ScriptDir & "\WidescreenLauncher\POP_Blank.7z"
Switch $desktopRatio
	Case 1.33   ; 4:3 aspect ratio, 1024x768
		...
		$hFile = FileOpen($POP_4_by_3_txt)
		For $i = 1 to _FileCountLines($POP_4_by_3_txt)
			_ArrayAdd($POP_4_by_3_array, FileReadLine($hFile, $i))
		Next
		FileClose($hFile)
		...
		If $patched == 1 Then
			If $patched_ProgramData == 1 Then
				...
				EndIf
			Else
				For $j = 1 To UBound($POP_4_by_3_array)-1
					$POP_4_by_3_name = $POP_4_by_3_array[$j]
					If $POP_4_by_3_name == "POP ~ " & $desktopX & "x" & $desktopY Then
						$7z_unpack_line = ' x -y -o' & '"' & @ScriptDir & '"' & ' ' & '"' & $POP_Backup & '"' & ' ' & '"' & '*' & '"'
						ShellExecuteWait("7za.exe", $7z_unpack_line, @AppDataCommonDir & "\SalFisher47\7za", "", @SW_HIDE)
						$7z_unpack_line = ' x -y -o' & '"' & @TempDir & '\POP1_WidescreenLauncher' & '"' & ' ' & '"' & $POP_4_by_3_7z & '"' & ' ' & '"' & $POP_4_by_3_name & '.xd3' & '"'
						ShellExecuteWait("7za.exe", $7z_unpack_line, @AppDataCommonDir & "\SalFisher47\7za", "", @SW_HIDE)
						$xdelta_patch_line_pop = ' -d -s ' & '"' & @ScriptDir & '\POP.exe' & '"' & ' ' & '"' & @TempDir & '\POP1_WidescreenLauncher\' & $POP_4_by_3_name & '.xd3' & '"' & ' ' & '"' & @TempDir & '\POP1_WidescreenLauncher\' & $POP_4_by_3_name & '.exe' & '"'
						RunWait(@AppDataCommonDir & "\SalFisher47\xd3\xd3.exe" & $xdelta_patch_line_pop, @AppDataCommonDir & "\SalFisher47\xd3", @SW_HIDE)
						FileCopy(@TempDir & '\POP1_WidescreenLauncher\' & $POP_4_by_3_name & '.exe', @ScriptDir & '\POP.exe', 1)
						DirRemove(@TempDir & '\POP1_WidescreenLauncher', 1)
						$supported_res = 1
						ExitLoop
					EndIf
				Next
				If $supported_res == 1 Then
					IniWrite(@AppDataCommonDir & "\SalFisher47\WidescreenLauncher\POP1.ini", "EXE", "patched", " 1")
					IniWrite($widescreen_fix_ini, "EXE", "patched", " 1")
					FileMove(@ScriptDir & "\POP.exe", @ScriptDir & "\POP_.exe", 0)
					FileInstall("Blank.exe", @ScriptDir & "\POP.exe", 0)
	...
	Case 1.25   ; 5:4 aspect ratio, 1280x1024
		...
		$hFile = FileOpen($POP_5_by_4_txt)
		For $i = 1 to _FileCountLines($POP_5_by_4_txt)
			_ArrayAdd($POP_5_by_4_array, FileReadLine($hFile, $i))
		Next
		FileClose($hFile)
		...
		If $patched == 1 Then
			If $patched_ProgramData == 1 Then
				...
				EndIf
			Else
				For $j = 1 To UBound($POP_5_by_4_array)-1
					$POP_5_by_4_name = $POP_5_by_4_array[$j]
					If $POP_5_by_4_name == "POP ~ " & $desktopX & "x" & $desktopY Then
						$7z_unpack_line = ' x -y -o' & '"' & @ScriptDir & '"' & ' ' & '"' & $POP_Backup & '"' & ' ' & '"' & '*' & '"'
						ShellExecuteWait("7za.exe", $7z_unpack_line, @AppDataCommonDir & "\SalFisher47\7za", "", @SW_HIDE)
						$7z_unpack_line = ' x -y -o' & '"' & @TempDir & '\POP1_WidescreenLauncher' & '"' & ' ' & '"' & $POP_5_by_4_7z & '"' & ' ' & '"' & $POP_5_by_4_name & '.xd3' & '"'
						ShellExecuteWait("7za.exe", $7z_unpack_line, @AppDataCommonDir & "\SalFisher47\7za", "", @SW_HIDE)
						$xdelta_patch_line_pop = ' -d -s ' & '"' & @ScriptDir & '\POP.exe' & '"' & ' ' & '"' & @TempDir & '\POP1_WidescreenLauncher\' & $POP_5_by_4_name & '.xd3' & '"' & ' ' & '"' & @TempDir & '\POP1_WidescreenLauncher\' & $POP_5_by_4_name & '.exe' & '"'
						RunWait(@AppDataCommonDir & "\SalFisher47\xd3\xd3.exe" & $xdelta_patch_line_pop, @AppDataCommonDir & "\SalFisher47\xd3", @SW_HIDE)
						FileCopy(@TempDir & '\POP1_WidescreenLauncher\' & $POP_5_by_4_name & '.exe', @ScriptDir & '\POP.exe', 1)
						DirRemove(@TempDir & '\POP1_WidescreenLauncher', 1)
						$supported_res = 1
						ExitLoop
					EndIf
	...
	Case 1.77   ; 16:9 aspect ratio, 1360x768
		...
		$hFile = FileOpen($POP_16_by_9_txt)
		For $i = 1 to _FileCountLines($POP_16_by_9_txt)
			_ArrayAdd($POP_16_by_9_array, FileReadLine($hFile, $i))
		Next
		FileClose($hFile)
		...
		If $patched == 1 Then
			If $patched_ProgramData == 1 Then
				...
				EndIf
			Else
				For $j = 1 To UBound($POP_16_by_9_array)-1
					$POP_16_by_9_name = $POP_16_by_9_array[$j]
					If $POP_16_by_9_name == "POP ~ " & $desktopX & "x" & $desktopY Then
						$7z_unpack_line = ' x -y -o' & '"' & @ScriptDir & '"' & ' ' & '"' & $POP_Backup & '"' & ' ' & '"' & '*' & '"'
						ShellExecuteWait("7za.exe", $7z_unpack_line, @AppDataCommonDir & "\SalFisher47\7za", "", @SW_HIDE)
						$7z_unpack_line = ' x -y -o' & '"' & @TempDir & '\POP1_WidescreenLauncher' & '"' & ' ' & '"' & $POP_16_by_9_7z & '"' & ' ' & '"' & $POP_16_by_9_name & '.xd3' & '"'
						ShellExecuteWait("7za.exe", $7z_unpack_line, @AppDataCommonDir & "\SalFisher47\7za", "", @SW_HIDE)
						$xdelta_patch_line_pop = ' -d -s ' & '"' & @ScriptDir & '\POP.exe' & '"' & ' ' & '"' & @TempDir & '\POP1_WidescreenLauncher\' & $POP_16_by_9_name & '.xd3' & '"' & ' ' & '"' & @TempDir & '\POP1_WidescreenLauncher\' & $POP_16_by_9_name & '.exe' & '"'
						RunWait(@AppDataCommonDir & "\SalFisher47\xd3\xd3.exe" & $xdelta_patch_line_pop, @AppDataCommonDir & "\SalFisher47\xd3", @SW_HIDE)
						FileCopy(@TempDir & '\POP1_WidescreenLauncher\' & $POP_16_by_9_name & '.exe', @ScriptDir & '\POP.exe', 1)
						DirRemove(@TempDir & '\POP1_WidescreenLauncher', 1)
						$supported_res = 1
						ExitLoop
					EndIf
	...
	Case 1.60   ; 16:10 aspect ratio, 1440x900
		...
		$hFile = FileOpen($POP_16_by_10_txt)
		For $i = 1 to _FileCountLines($POP_16_by_10_txt)
			_ArrayAdd($POP_16_by_10_array, FileReadLine($hFile, $i))
		Next
		FileClose($hFile)
		...
		If $patched == 1 Then
			If $patched_ProgramData == 1 Then
				...
				EndIf
			Else
				For $j = 1 To UBound($POP_16_by_10_array)-1
					$POP_16_by_10_name = $POP_16_by_10_array[$j]
					If $POP_16_by_10_name == "POP ~ " & $desktopX & "x" & $desktopY Then
						$7z_unpack_line = ' x -y -o' & '"' & @ScriptDir & '"' & ' ' & '"' & $POP_Backup & '"' & ' ' & '"' & '*' & '"'
						ShellExecuteWait("7za.exe", $7z_unpack_line, @AppDataCommonDir & "\SalFisher47\7za", "", @SW_HIDE)
						$7z_unpack_line = ' x -y -o' & '"' & @TempDir & '\POP1_WidescreenLauncher' & '"' & ' ' & '"' & $POP_16_by_10_7z & '"' & ' ' & '"' & $POP_16_by_10_name & '.xd3' & '"'
						ShellExecuteWait("7za.exe", $7z_unpack_line, @AppDataCommonDir & "\SalFisher47\7za", "", @SW_HIDE)
						$xdelta_patch_line_pop = ' -d -s ' & '"' & @ScriptDir & '\POP.exe' & '"' & ' ' & '"' & @TempDir & '\POP1_WidescreenLauncher\' & $POP_16_by_10_name & '.xd3' & '"' & ' ' & '"' & @TempDir & '\POP1_WidescreenLauncher\' & $POP_16_by_10_name & '.exe' & '"'
						RunWait(@AppDataCommonDir & "\SalFisher47\xd3\xd3.exe" & $xdelta_patch_line_pop, @AppDataCommonDir & "\SalFisher47\xd3", @SW_HIDE)
						FileCopy(@TempDir & '\POP1_WidescreenLauncher\' & $POP_16_by_10_name & '.exe', @ScriptDir & '\POP.exe', 1)
						DirRemove(@TempDir & '\POP1_WidescreenLauncher', 1)
						$supported_res = 1
						ExitLoop
					EndIf
